(function (root, factory) {
    if (typeof exports === 'object') {
        // CommonJS
        factory(exports, require("escodegen"), require("./source-map/source-map-generator")
		,require("./source-map/source-map-consumer"));
    } else if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define(['exports', 'escodegen'], factory);
    } else {
        // Browser globals
        factory((root.expander = {}), root._, root.parser);
    }
}(this, function (exports, codegen, sourceMapG, sourceMapC) {
